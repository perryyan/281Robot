...
sfr at (0xA3) ACSRA; // Comparator A Control Register CSA1 CSA0 CONA CFA CENA CMA CMA1 CMA0
	#define CSA1    0x80
	#define CSA0    0x40
	#define CONA    0x20
	#define CFA     0x10
	...
	#define CMA1    0x02
	#define CMA0    0x01
sfr at (0xAB) ACSRB; // Comparator B Control Register CSB1 CSB0 CONB CFB CENB CMB CMB1 CMB0
	#define CSB1    0x80
	#define CSB0    0x40
	#define CONB    0x20
	#define CFB     0x10
